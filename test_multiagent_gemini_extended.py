#!/usr/bin/env python3
"""全面测试multiagent Gemini延长思考模式修复效果"""
...
# 添加multiagent到Python路径
sys.path.insert(0, '/home/wangzi/.claude/skills/multiagent/skills/multiagent')

# 设置日志
logging.basicConfig(level=logging.INFO)
log = logging.getLogger(__name__)

def test_multiagent_gemini_extended():
    """测试multiagent的Gemini延长思考模式功能"""
                        ...
                        if thinking_found:
                            ...
                            if extended_found:
                                ...
                                if new_mode == 'extended':
                                    log.info("✅ Pro Extended Thinking模式启用成功!")
                                else:
...
if __name__ == "__main__":
    test_multiagent_gemini_extended()